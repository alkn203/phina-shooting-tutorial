[f:id:alkn203:20190620170715g:plain]
[:contents]

【phina.js】2Dシューティングチュートリアル =当たり判定とアニメーションイベントとグループ=

### はじめに
[前回](https://keeponcoding.hatenablog.com/entry/2019/06/13/084442)は、敵を追加して敵が弾を発射するようにしました。今回は、当たり判定を作成します。
...
```
<figure class="figure-image figure-image-fotolife" title="プレイヤーの当たり判定">[f:id:alkn203:20190619130844j:plain]<figcaption>プレイヤーの当たり判定</figcaption></figure>
